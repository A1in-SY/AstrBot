...
/**
 * Get a cron job detail
 */
export const getCronJob = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetCronJobData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetCronJobResponse, GetCronJobError, ThrowOnError>({
        ...options,
...
/**
 * Reset script task state
 */
export const resetCronScriptState = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ResetCronScriptStateData, ThrowOnError>) => {
    return (options?.client ?? client).post<ResetCronScriptStateResponse, ResetCronScriptStateError, ThrowOnError>({
        ...options,
        url: '/api/v1/cron/jobs/{job_id}/state/reset'
    });
};

/**
 * Validate script task source
 */
export const validateCronScript = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ValidateCronScriptData, ThrowOnError>) => {
    return (options?.client ?? client).post<ValidateCronScriptResponse, ValidateCronScriptError, ThrowOnError>({
        ...options,
        url: '/api/v1/cron/script/validate'
    });
};

/**
 * List supported script language versions
 */
export const cronScriptLanguages = <ThrowOnError extends boolean = false>(options?: OptionsLegacyParser<unknown, ThrowOnError>) => {
    return (options?.client ?? client).get<CronScriptLanguagesResponse, CronScriptLanguagesError, ThrowOnError>({
        ...options,
        url: '/api/v1/cron/script/languages'
    });
};
...
/**
 * Get execution trace overview
 */
export const getExecutionTraceOverview = <ThrowOnError extends boolean = false>(options?: OptionsLegacyParser<unknown, ThrowOnError>) => {
    return (options?.client ?? client).get<GetExecutionTraceOverviewResponse, GetExecutionTraceOverviewError, ThrowOnError>({
        ...options,
        url: '/api/v1/traces/overview'
    });
};

/**
 * Get execution trace configuration
 */
export const getExecutionTraceConfig = <ThrowOnError extends boolean = false>(options?: OptionsLegacyParser<unknown, ThrowOnError>) => {
    return (options?.client ?? client).get<GetExecutionTraceConfigResponse, GetExecutionTraceConfigError, ThrowOnError>({
        ...options,
        url: '/api/v1/traces/config'
    });
};

/**
 * Update execution trace configuration
 */
export const updateExecutionTraceConfig = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<UpdateExecutionTraceConfigData, ThrowOnError>) => {
    return (options?.client ?? client).put<UpdateExecutionTraceConfigResponse, UpdateExecutionTraceConfigError, ThrowOnError>({
        ...options,
        url: '/api/v1/traces/config'
    });
};
...
/**
 * Get data-driven execution trace filter options
 */
export const getExecutionTraceFilterOptions = <ThrowOnError extends boolean = false>(options?: OptionsLegacyParser<unknown, ThrowOnError>) => {
    return (options?.client ?? client).get<GetExecutionTraceFilterOptionsResponse, GetExecutionTraceFilterOptionsError, ThrowOnError>({
        ...options,
        url: '/api/v1/traces/filter-options'
    });
};
 ...
 */
export const listExecutionTraces = <ThrowOnError extends boolean = false>(options?: OptionsLegacyParser<ListExecutionTracesData, ThrowOnError>) => {
    return (options?.client ?? client).get<ListExecutionTracesResponse, ListExecutionTracesError, ThrowOnError>({
        ...options,
        url: '/api/v1/traces'
    });
};
...
/**
 * Clear terminal execution traces
 */
export const clearExecutionTraces = <ThrowOnError extends boolean = false>(options?: OptionsLegacyParser<unknown, ThrowOnError>) => {
    return (options?.client ?? client).delete<ClearExecutionTracesResponse, ClearExecutionTracesError, ThrowOnError>({
        ...options,
        url: '/api/v1/traces'
    });
};
...
/**
 * Get an execution trace artifact body
 */
export const getExecutionTraceArtifact = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetExecutionTraceArtifactData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetExecutionTraceArtifactResponse, GetExecutionTraceArtifactError, ThrowOnError>({
        ...options,
        url: '/api/v1/traces/artifacts/{content_hash}'
    });
};

/**
 * Get execution trace detail
 */
export const getExecutionTrace = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetExecutionTraceData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetExecutionTraceResponse, GetExecutionTraceError, ThrowOnError>({
        ...options,
...
/**
 * Delete one terminal execution trace
 */
export const deleteExecutionTrace = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<DeleteExecutionTraceData, ThrowOnError>) => {
    return (options?.client ?? client).delete<DeleteExecutionTraceResponse, DeleteExecutionTraceError, ThrowOnError>({
        ...options,
        url: '/api/v1/traces/{trace_id}'
    });
};
...
/**
 * Run execution trace retention cleanup
 */
export const cleanupExecutionTraces = <ThrowOnError extends boolean = false>(options?: OptionsLegacyParser<unknown, ThrowOnError>) => {
    return (options?.client ?? client).post<CleanupExecutionTracesResponse, CleanupExecutionTracesError, ThrowOnError>({
        ...options,
        url: '/api/v1/traces/cleanup'
    });
};
